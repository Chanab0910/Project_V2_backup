...
countries = [Country(country_name="Argentina", attack=87, defense=85, tier=1),
             ...
             Country(country_name="Croatia", attack=78, defense=78, tier=2),
             Country(country_name="Czech Republic", attack=73, defense=75, tier=4),
             Country(country_name="Denmark", attack=75, defense=79, tier=4),
             Country(country_name="England", attack=86, defense=84, tier=1),
             Country(country_name="Finland", attack=72, defense=68, tier=4),
             Country(country_name="France", attack=86, defense=84, tier=1),
             Country(country_name="Germany", attack=84, defense=84, tier=1),
             Country(country_name="Hungary", attack=75, defense=73, tier=3),
             Country(country_name="Iceland", attack=70, defense=71, tier=4),
             Country(country_name="Ireland", attack=70, defense=71, tier=4),
             Country(country_name="Italy", attack=84, defense=83, tier=1),
             Country(country_name="Mexico", attack=78, defense=76, tier=2),
             Country(country_name="Ghana", attack=77, defense=74, tier=3),
             Country(country_name="Netherlands", attack=84, defense=83, tier=1),
             ...
             Country(country_name="Spain", attack=84, defense=84, tier=1),
             ...
             Country(country_name="China", attack=75, defense=73, tier=3),
             ]
stages = [
