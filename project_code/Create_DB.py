...
countries = [Country(country_name="Argentina", attack=84, defense=82, tier=1),
             ...
             Country(country_name="France", attack=85, defense=83, tier=1),
             Country(country_name="Germany", attack=80, defense=80, tier=1),
