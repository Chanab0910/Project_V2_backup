...
class GUI(tk.Tk):
    ...
    def __init__(self):
        ...
        self.Canada_button = tk.Button(self, image=self.Canada)
        self.Croatia_button = tk.Button(self, image=self.Croatia)
        self.Czech_button = tk.Button(self, image=self.Czech)
        self.Denmark_button = tk.Button(self, image=self.Denmark)
        self.England_button = tk.Button(self, image=self.England)
        self.Finland_button = tk.Button(self, image=self.Finland)
        self.France_button = tk.Button(self, image=self.France)
        self.Germany_button = tk.Button(self, image=self.Germany)
        self.Hungary_button = tk.Button(self, image=self.Hungary)
        self.Iceland_button = tk.Button(self, image=self.Iceland,)
        self.Ireland_button = tk.Button(self, image=self.Ireland,)
        self.Italy_button = tk.Button(self, image=self.Italy, )
        self.Mexico_button = tk.Button(self, image=self.Mexico, )
        self.Ghana_button = tk.Button(self, image=self.Ghana,)
        self.Netherlands_button = tk.Button(self, image=self.Netherlands,)
        self.Morocco_button = tk.Button(self, image=self.Morocco, )
        self.Norway_button = tk.Button(self, image=self.Norway, )
        self.Poland_button = tk.Button(self, image=self.Poland,)
        self.Portugal_button = tk.Button(self, image=self.Portugal,)
        self.Romania_button = tk.Button(self, image=self.Romania,)
        self.Scotland_button = tk.Button(self, image=self.Scotland,)
        self.Spain_button = tk.Button(self, image=self.Spain, )
        self.Sweden_button = tk.Button(self, image=self.Sweden, )
        self.Ukraine_button = tk.Button(self, image=self.Ukraine, )
        self.USA_button = tk.Button(self, image=self.USA, )
        self.Wales_button = tk.Button(self, image=self.Wales,)
        self.Japan_button = tk.Button(self, image=self.Japan,)
        self.China_button = tk.Button(self, image=self.China, )
