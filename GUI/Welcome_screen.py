...
class TestGUI(tk.Tk):
    ...
    def __init__(self):
        ...
        self.bg_image = tk.PhotoImage(file="../../OneDrive - Highgate School/Project_V2/img/bg.png")
        self.start_image = tk.PhotoImage(file="../../OneDrive - Highgate School/Project_V2/img/start.png")
        self.quit_image = tk.PhotoImage(file="../../OneDrive - Highgate School/Project_V2/img/quit.png")
        self.title_image = tk.PhotoImage(file="../../OneDrive - Highgate School/Project_V2/img/title.png")
